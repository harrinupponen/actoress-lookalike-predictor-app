...
train_path = '../actoress-images/train'
valid_path = '../actoress-images/valid'
...
valid_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.mobilenet.preprocess_input).flow_from_directory(valid_path, target_size=(224, 224), batch_size=5)
...
model.fit_generator(train_batches, steps_per_epoch=60, validation_data=valid_batches, validation_steps=10, epochs=30, verbose=2)

#Finally, save the model
model.save('../mn_actoress_model2.h5')